...
<body class="font-sans antialiased px-20">
    <!-- Navigation Menu -->
    <nav class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl sm:px-6">
            <div class="flex justify-between h-16">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="/" wire:navigate class="text-2xl font-bold text-gray-800">Livewire Demonstration</a>
                </div>
                <!-- Navigation Links -->
                ...
                <div class="flex items-center md:hidden">
                    <button id="mobile-menu-btn" class="text-gray-600 hover:text-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-800">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-gray-50">
            <a href="{{ route('counter-tool') }}" wire:navigate class="block text-gray-600 hover:text-gray-800 px-4 py-2">Home</a>
            <a href="{{ route('todo-tasks') }}" wire:navigate class="block text-gray-600 hover:text-gray-800 px-4 py-2">About</a>
            <a href="{{ route('todo-tasks-v2') }}" wire:navigate class="block text-gray-600 hover:text-gray-800 px-4 py-2">Services</a>
            <a href="{{ route('search-tool') }}" wire:navigate class="block text-gray-600 hover:text-gray-800 px-4 py-2">Contact</a>
        </div>
    </nav>
